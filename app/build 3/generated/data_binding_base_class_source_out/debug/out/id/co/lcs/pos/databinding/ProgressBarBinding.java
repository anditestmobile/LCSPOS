...
public final class ProgressBarBinding implements ViewBinding {
  ...
  private ProgressBarBinding(@NonNull RelativeLayout rootView, @NonNull ProgressBar progressBar1) {
  ...
  public static ProgressBarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProgressBarBinding((RelativeLayout) rootView, progressBar1);
    }

...
import id.co.lcs.pos.activity.DownPaymentActivity;
import id.co.lcs.pos.activity.PaymentActivity;
import id.co.lcs.pos.printer.PrinterSettingConstant;

public class DialogDownPaymentAdapter extends RecyclerView.Adapter<DialogDownPaymentAdapter.MyViewHolder> {

    private LayoutInflater inflater;
    private List<PortInfo> listInfo;
    private DownPaymentActivity mContext;


    public DialogDownPaymentAdapter(DownPaymentActivity ctx, List<PortInfo> listInfo){
...
//                    Crea.textView.setText("You have selected : "+materialList[getAdapterPosition()]);
                    DownPaymentActivity.dialog.dismiss();
                }
            });
